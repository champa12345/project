                    ...
                    <form action="#" method="post" id="product_addtocart_form">
                                ...
                                <div class="slider-items-products">
                                  <div id="jtv-more-views-img" class="product-flexslider hidden-buttons product-img-thumb">
                                    <div class="slider-items slider-width-col4 block-content">
                                      <div class="more-views-items"> <a href="#" data-image="images/products/product-fashion-2.jpg" data-zoom-image="images/products/product-fashion-2.jpg"> <img id="product-zoom"  src="images/products/product-fashion-2.jpg" alt="product-image"/> </a></div>
                                      <div class="more-views-items"> <a href="#" data-image="images/products/product-fashion-3.jpg" data-zoom-image="images/products/product-fashion-3.jpg"> <img id="product-zoom"  src="images/products/product-fashion-3.jpg" alt="product-image"/> </a></div>
                                      <div class="more-views-items"> <a href="#" data-image="images/products/product-fashion-4.jpg" data-zoom-image="images/products/product-fashion-4.jpg"> <img id="product-zoom"  src="images/products/product-fashion-4.jpg" alt="product-image"/> </a></div>
                                      <div class="more-views-items"> <a href="#" data-image="images/products/product-fashion-5.jpg" data-zoom-image="images/products/product-fashion-5.jpg"> <img id="product-zoom"  src="images/products/product-fashion-5.jpg" alt="product-image"/> </a> </div>
                                      <div class="more-views-items"> <a href="#" data-image="images/products/product-fashion-6.jpg" data-zoom-image="images/products/product-fashion-6.jpg"> <img id="product-zoom"  src="images/products/product-fashion-6.jpg" alt="product-image" /> </a></div>
                                    </div>
                                  </div>
                                </div>
                          </div>
                      ...
                      <div class="product-shop col-lg-8 col-sm-7 col-xs-12">
                        ...
                        <div class="price-block">
                          <div class="price-box">
                            <p class="special-price"> <span class="price-label">Special Price</span><span class="price"> $149.99 </span></p>
