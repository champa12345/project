          ...
          <form action="#" method="post" id="product_addtocart_form">
            <div class="product-img-box col-lg-4 col-sm-5 col-xs-12">
              <div class="product-image">
                <div class="product-full">
                  ...
                  <img id="product-zoom" src="../images/products/{{$sanpham->images[0]->link}}" data-zoom-image="../images/products/{{$sanpham->images[0]->link}}" alt="product-image"/> 
                </div>
                        ...
                        <div id="jtv-more-views-img" class="product-flexslider hidden-buttons product-img-thumb">
                            <div class="slider-items slider-width-col4 block-content">
                                ...
                                <div class="more-views-items">
                                    <a href="#" data-image="../images/products/{{ $img ? $img->link : 'product-fashion-2.jpg' }}" data-zoom-image="../images/products/{{ $img ? $img->link : 'product-fashion-2.jpg' }}"> 
                                        <img id="product-zoom"  src="../images/products/{{ $img ? $img->link : 'product-fashion-2.jpg' }}" alt="product-image"/> 
                                    </a>
                                </div>
                                @endforeach
            ...
            <div class="product-shop col-lg-8 col-sm-7 col-xs-12">
              ...
              <div class="price-block">
                <div class="price-box">
                  <p class="special-price"> <span class="price-label">Special Price</span><span class="price">{{$sanpham->price}}</span></p>
      ...
      <div class="related-block">
        <div id="jtv-related-products-slider" class="product-flexslider hidden-buttons">
          <div class="slider-items slider-width-col4 products-grid">
            @foreach($sanphamlienquan->products as $pr)
            <div class="item">
              <div class="item-inner">
                <div class="item-img">
                  <div class="item-img-info">
                    <a class="product-image" title="Product tilte is here" href="#"> 
                      <img alt="Product tilte is here" src="images/products/product-fashion-5.jpg">
                    </a>
                    <div class="new-label new-top-left">new</div>
                ...
                <div class="item-info">
                  <div class="info-inner">
                    <div class="item-title"> <a title="Product tilte is here" href="#">{{$pr->name}} </a> </div>
                    <div class="item-content">
                      ...
                      <div class="item-price">
                        <div class="price-box"> <span class="regular-price"> <span class="price">{{$pr->price}}</span></span></div>
                      </div>
                      <div class="actions">
